                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <c:forEach var="poster" items="${posters}">
                                                <tr>
                                                    ...
                                                    <td><c:out value="${poster.posterTime}"/></td>
                                                    <td><c:out value="${poster.posterContent}"/></td>
                                                    <td><a href="EditPoster?posterid=${poster.posterID}"
                                                           class="btn btn-info">编辑</a></td>
                                                    <td><a href="SetTop?posterid=${poster.posterID}"
                                                           class="btn btn-primary">置顶</a></td>
                                                    <td><a href="DeletePoster?posterid=${poster.posterID}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:if test="${user.isLock==false}">
                                                            <a href="AddLock?userid=${user.userID}"
                                                               class="btn btn-danger">加锁</a>
                                                        </c:if>
                                                        <c:if test="${user.isLock==true}">
                                                            <a href="DisLock?userid=${user.userID}"
                                                               class="btn btn-success">解锁</a>
                                                        </c:if>
                                                    </td>
