...
<body>
<div class="row" style="background-image:url('images/nanyou_1.jpeg')">
    <div class="col-md-3 col-sm-3">
    </div>
    <div class="col-md-6 col-sm-6 main">
        <div class="panel panel-default">
            <div class="panel-heading">
                <!--img href="homepage.jsp" src="images/icon_nanyou.jpg" alt="欢迎来到南油论坛~"/-->
