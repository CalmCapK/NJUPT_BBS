...
<head>
    ...
    <style>
        body {
            background: url(./images/nanyou_1.jpeg) no-repeat center center;
...
<section class="container">
    <div class="content-wrap">
        <div class="content">
            <br><br><br><br>
            <div id="respond">
                <form id="comment-form" name="comment-form" action="EditMyReply"
                      method="POST">
                    <div class="comment">
                        ...
                        <div class="comment-box">
							<textarea name="replycontent"
                                      ...
                                      tabindex="3">${reply.replyContent}</textarea>
